...
// Player Header for video playback pages
export function PlayerHeader({
  ...
  return (
    <Header
      variant="minimal"
      className={cn("bg-black/90 text-white border-black/20", className)}
      {...props}
    >
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center space-x-4">
          ...
          {movieTitle && (
            <h1 className="text-lg font-semibold truncate">{movieTitle}</h1>
          )}
        </div>
